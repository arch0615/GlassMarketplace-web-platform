...
import { LayoutDashboard, FilePlus, ShoppingBag, LogOut, Eye, ChevronRight, Sun, Moon } from 'lucide-react'
    ...
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <aside className="w-64 flex-shrink-0 bg-white dark:bg-slate-800 border-r border-slate-100 dark:border-slate-700 flex flex-col">
        ...
        <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-700">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 ml-10">Portal Cliente</p>
        </div>
